...
PHASES=(
  ...
  "p12|P12_CONTRAST_LAB_SPEC.md|phase/p12-contrast-lab|P12: Contrast Lab — click-to-inspect on live preview, WCAG AA/AAA + APCA contrast, nearest-passing-fix suggestion, CVD colorblind overlay"
)
